...
// checks if the PatchedClientUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedClientUser{}

// PatchedClientUser Handles serialization and deserialization of user objects
type PatchedClientUser struct {
...
func (o *PatchedClientUser) SetPhonenumberNil() {
...
func (o *PatchedClientUser) SetGenderNil() {
	o.Gender.Set(nil)
}
...
func (o *PatchedClientUser) SetDOBNil() {
	o.DOB.Set(nil)
}
...
// SetProfile gets a reference to the given ClientProfile and assigns it to the Profile field.
...
func (o PatchedClientUser) MarshalJSON() ([]byte, error) {
...
func (o PatchedClientUser) ToMap() (map[string]interface{}, error) {
...
type NullablePatchedClientUser struct {
	value *PatchedClientUser
	isSet bool
}

func (v NullablePatchedClientUser) Get() *PatchedClientUser {
	return v.value
}

func (v *NullablePatchedClientUser) Set(val *PatchedClientUser) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedClientUser) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedClientUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedClientUser(val *PatchedClientUser) *NullablePatchedClientUser {
	return &NullablePatchedClientUser{value: val, isSet: true}
}

func (v NullablePatchedClientUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedClientUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
