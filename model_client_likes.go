...
// checks if the ClientLikes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClientLikes{}
...
func (o ClientLikes) ToMap() (map[string]interface{}, error) {
...
func (o *ClientLikes) UnmarshalJSON(data []byte) (err error) {
	...
	varClientLikes := _ClientLikes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClientLikes)

	if err != nil {
		return err
	}

	*o = ClientLikes(varClientLikes)
